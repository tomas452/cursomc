...
import com.tomasgoncalves.Cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir clientes porque há entidades relacionadas.");
		}
	}
